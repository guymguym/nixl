...
/**
 * Implementation of awsS3IBMClient constructor.
 * Initializes the IBM Storage Scale S3 client with custom parameters.
 *
 * @param custom_params Custom parameters containing S3 configuration
 * @param executor Optional executor for async operations
 */
awsS3IBMClient::awsS3IBMClient(nixl_b_params_t *custom_params,
                               std::shared_ptr<Aws::Utils::Threading::Executor> executor)
    : awsS3AccelClient(custom_params, executor) {
    NIXL_DEBUG << "Initialized IBM Storage Scale Client";
}

/**
 * Asynchronously puts an object to IBM Storage Scale S3 using RDMA acceleration.
 ...
 * @param offset Offset within the object (must be 0 for IBM Storage Scale)
 ...
 */
void
awsS3IBMClient::putObjectRdmaAsync(std::string_view key,
                                   uintptr_t data_ptr,
                                   size_t data_len,
                                   size_t offset,
...
/**
 * Asynchronously gets an object from IBM Storage Scale S3 using RDMA acceleration.
 ...
 */
void
awsS3IBMClient::getObjectRdmaAsync(std::string_view key,
                                   uintptr_t data_ptr,
                                   size_t data_len,
                                   size_t offset,
                                   std::string_view rdma_desc,
