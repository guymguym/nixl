...
#ifndef NIXL_OBJ_PLUGIN_S3_IBM_CLIENT_H
#define NIXL_OBJ_PLUGIN_S3_IBM_CLIENT_H
...
/**
 * S3 Accelerated Object Client for use with IBM Storage Scale - Inherits from Accelerated S3 Client.
 * This client presents Put and GetObject interfaces to enable RDMA for S3-compatible storage using
 * the cuObject API
 */
class awsS3IBMClient : public awsS3AccelClient, public iIBMS3RdmaClient {
public:
    /**
     * Constructor that creates an AWS S3 client for use with IBM Storage Scale from custom
     * parameters.
     * @param custom_params Custom parameters containing S3 configuration
     * @param executor Optional executor for async operations
     */
    awsS3IBMClient(nixl_b_params_t *custom_params,
                   std::shared_ptr<Aws::Utils::Threading::Executor> executor = nullptr);

    virtual ~awsS3IBMClient() = default;
...
#endif // NIXL_OBJ_PLUGIN_S3_IBM_CLIENT_H
