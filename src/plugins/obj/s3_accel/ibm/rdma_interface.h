...
#ifndef NIXL_OBJ_PLUGIN_S3_IBM_RDMA_INTERFACE_H
#define NIXL_OBJ_PLUGIN_S3_IBM_RDMA_INTERFACE_H
 ...
 * Only IBM-specific clients implement this interface.
 */
class iIBMS3RdmaClient {
public:
    virtual ~iIBMS3RdmaClient() = default;
...
#endif // NIXL_OBJ_PLUGIN_S3_IBM_RDMA_INTERFACE_H
