...
#ifndef NIXL_OBJ_PLUGIN_S3_IBM_ENGINE_IMPL_H
#define NIXL_OBJ_PLUGIN_S3_IBM_ENGINE_IMPL_H

#include "s3_accel/engine_impl.h"
#include "s3_accel/ibm/client.h"
#include <cuobjclient.h>

/**
 * S3 IBM Storage Scale Engine Implementation.
 * This class provides RDMA-accelerated S3 object storage operations specifically
 * for IBM Storage Scale storage systems. It inherits from S3AccelObjEngineImpl and
 * implements the cuObject API for GPU-direct storage operations.
 */
class S3IBMStorageScaleEngineImpl : public S3AccelObjEngineImpl {
public:
    /**
     * Constructor that initializes the S3 IBM Storage Scale engine.
     * Creates both the S3 client and cuObject client for RDMA operations.
     *
     * @param init_params Backend initialization parameters
     */
    explicit S3IBMStorageScaleEngineImpl(const nixlBackendInitParams *init_params);
    /**
